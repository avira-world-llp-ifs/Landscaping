...
import Pic from '../../public/inverseWhiteLogo.png'
    ...
    <div className="min-h-screen">
      ...
      <div className="relative bg-[#003087] text-white py-24">
        ...
        <div className="absolute bottom-0 right-0 w-1/3 h-full hidden lg:block">
          <div className="relative h-full w-full " style={{alignContent:'center'}}>
            <Image src={Pic} alt="Portfolio showcase" width={800} height={800}   />
          </div>
        </div>
      </div>
