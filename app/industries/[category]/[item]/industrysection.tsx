...
export default function IndustrySection({ title, industryStatus, challenges, requirements }: IndustrySectionProps) {
        ...
        >
          ...
          <div className="space-y-4">
            {statusItems.length > 0 ? (
              ...
              <p
                className={`text-sm ${hoveredCard === "status" ? "text-white" : "text-gray-600"} group-hover:text-white`}
              >
        ...
        >
          ...
          <div className="space-y-4">
            {challengeItems.length > 0 ? (
              ...
              <p
                className={`text-sm ${hoveredCard === "challenges" ? "text-white" : "text-gray-600"} group-hover:text-white`}
              >
        ...
        >
          ...
          <div className="space-y-4">
            {requirementItems.length > 0 ? (
              ...
              <p
                className={`text-sm ${hoveredCard === "requirements" ? "text-white" : "text-gray-600"} group-hover:text-white`}
              >
