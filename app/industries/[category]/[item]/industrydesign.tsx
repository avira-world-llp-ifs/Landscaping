...
// Update the props interface to include the new properties
interface Props {
  data: ServiceData
  type: "industry" | "service"
  parentTitle?: string
...
export default function IndustryDesign({ data, type, parentTitle, parentPath, category, categoryPath }: Props) {
  const [isSticky, setIsSticky] = useState(false)
  const [showBackToTop, setShowBackToTop] = useState(false)
  const [isVisible, setIsVisible] = useState<{ [key: string]: boolean }>({})
  ...
  // Update the ServiceDetailHeader component call
  return (
    <div className="font-sans text-gray-800">
      {/* Hero Section */}
      <div className="bg-[#003087] py-20 relative transition-all duration-500 ease-in-out animate-fadeIn">
