...
export default function IndustryCategoryPage({ params }: { params: { category: string } }) {
  ...
  const categoryData = getIndustryCategory(params.category)
  ...
  return (
    <div>
      <ServiceDetailHeader title={categoryData.title} category="Industries" categoryPath="/industries" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-16">
            <div className="relative h-96 mb-8 rounded-xl overflow-hidden">
              <Image
                src={categoryData.image || "/placeholder.svg?height=600&width=1200"}
            ...
            <div className="bg-gray-50 p-8 rounded-lg mb-12">
              <h3 className="text-xl font-bold mb-4 text-[#003087]">{categoryData.subtitle || "Industry Overview"}</h3>
            ...
            {industryItems.map((item: IndustryItem, index: number) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    href={`/industries/${params.category}/${item.slug}`}
